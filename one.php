								...
								<div class="content">
									...
									<!-- Content -->
										<section class="box features">
											<h2 class="major"><span>100 LEVEL</span></h2>
						...
						<div class="table-responsive">
							<table border="8">
								...
								<?php
									...
									$query_courses_first_semester="SELECT * FROM courses WHERE semester='first' AND level='one' ";
						...
						<div class="table-responsive">
							<table border="8">
								...
								<?php
									...
									$query_courses_second_semester="SELECT * FROM courses WHERE semester='second' AND level='one' ";
